    ...
    public partial class Jarvis : Form
    {
       ...
       public static Bitmap bg = new Bitmap(Screen.PrimaryScreen.Bounds.Width, Screen.PrimaryScreen.Bounds.Height);
        ...
        private void Jarvis_Load(object sender, EventArgs e)
        {
            ...
            string[] lista = { "go away", "open safe mail", "come back", "write commands", "search", "open origin", "disable", "open youtube", "open notepad", "open command line", "show commands", "open skype", "open reddit", "speak selected text", "Hello", "Hi", "open firefox", "open facebook", "what time is it", "open hacker news", "exit", "open code", "take screenshot", "etsi" };
